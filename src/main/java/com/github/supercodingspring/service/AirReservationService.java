...
public class AirReservationService {
    ...
    public Page<FlightDto> findFlightsWithTypeAndPageable(String ticketType, Pageable pageable) {
        Page<Flight> flightList = flightJpaRepository.findAllByAirlineTicket_TicketType(ticketType, pageable);
        return flightList.map(FlightMapper.INSTANCE::flightToFlightDto);
    }

    public Set<String> findFlightArrivalLocation(String userName) {
        Set<String> locations = reservationJpaRepository.findDistinctArrivalLocationByPassengerUserUserName(userName);
        return locations;
    }
}
